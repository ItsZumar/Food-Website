...
export const Signin = () => {
  return (
    <section class="bg-gray-50 min-h-screen flex items-center justify-center px-16 py-6 md:col-span-6 bg-gray-100">
      <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-6xl p-5 items-center">
        <div class="md:w-1/2 px-8 md:px-16">
          ...
          <form action="" class="flex flex-col gap-4">
            ...
            <Link to="/" class="bg-primary rounded-xl text-white py-2 hover:scale-105 duration-300 text-center">
              Login
            </Link>
          </form>
          ...
          <button class="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-primary">
        ...
        <div class="md:block hidden w-1/2">
          <img class="rounded-2xl" src={food} alt="sidePic" />
        </div>
      </div>
    </section>
  );
